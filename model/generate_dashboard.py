...
TRACK_COURSE_DATA = {
    ...
    "門別": {
        "overview": "1周1600m・直線330mで、大井に次いで地方競馬で2番目に長い直線を持つ。右回り。"
                    "元トレーニングセンターを改造したコースで、追い込み馬でも届きやすいとされる。"
                    "ホッカイドウ競馬の拠点でナイター開催。",
        "distances": {},
    },
    "盛岡": {
        "overview": "1周1600m(ダート)・直線約400mで、地方競馬で唯一芝コースも併設。左回り。"
                    "芝・ダートともコース全体の高低差が約4mあり、地方競馬としては珍しい起伏の大きいコースとされる。",
        "distances": {},
    },
    "金沢": {
        "overview": "1周1200m・直線236m。右回りで、4つのコーナー全てにポケット(発走地点の窪み)が"
                    "設けられているのが特徴。日本海側唯一の地方競馬場。",
        "distances": {},
    },
    "名古屋": {
        "overview": "1周1180m・直線約240m。3・4コーナーに入口が緩く出口が急なスパイラルカーブを採用。"
                    "小回りで先行馬がやや有利とされる。",
        "distances": {},
    },
    "園田": {
        "overview": "1周1051mで地方競馬最短の小回りコース。直線213m。右回り。"
                    "向正面から3コーナーにかけて高低差1.2mの上り坂があり、コンパクトな分"
                    "逃げ・先行馬が圧倒的有利とされる。3・4コーナーはスパイラルカーブ。",
        "distances": {},
    },
    "高知": {
        "overview": "1周1100m・右回り。1・2コーナーの半径が3・4コーナーより小さいのが特徴。"
                    "内ラチ沿いの砂が深く、内を開けてレースが行われる傾向があるとされる。"
                    "通年ナイター開催(愛称「夜さ恋ナイター」)。",
        "distances": {},
    },
    "佐賀": {
        "overview": "1周1100m・直線200m。右回りで高低差は約1mとほぼ平坦。"
                    "他場に比べて砂の粒が大きく、パワーのある馬が有利とされる。",
        "distances": {},
    },
}
...
TRACK_LAP_LENGTH = {"大井": 1600, "船橋": 1400, "浦和": 1200, "川崎": 1200,
                     "門別": 1600, "盛岡": 1600, "金沢": 1200, "名古屋": 1180, "園田": 1051,
                     "高知": 1100, "佐賀": 1100}
TRACK_HOME_STRETCH = {"大井": 386, "船橋": 310, "浦和": 200, "川崎": 300,
                       "門別": 330, "盛岡": 400, "金沢": 236, "名古屋": 240, "園田": 213,
                       "高知": 240, "佐賀": 200}
TRACK_TURN = {"大井": "right", "船橋": "left", "浦和": "left", "川崎": "left",
              "門別": "right", "盛岡": "left", "金沢": "right", "名古屋": "right", "園田": "right",
              "高知": "right", "佐賀": "right"}
